...
public class TapBarrelGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public TapBarrelGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RitualsOfTheWildsModMenus.TAP_BARREL_GUI.get(), id);
		...
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 62, 58) {
			private final int slot = 6;
		}));
		this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 80, 58) {
			private final int slot = 7;
		}));
		this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 98, 58) {
