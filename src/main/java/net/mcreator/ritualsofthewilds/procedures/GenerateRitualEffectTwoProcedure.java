...
public class GenerateRitualEffectTwoProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.RITUALRECIPESREGENERATE.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Rituals/eng"), File.separator + "14ritual.json");
			try {
			...
			object.addProperty("Ritual Name", "Effect Type Ritual: Second Level Rune effect");
			...
			object.addProperty("Block Z-3 ID or Tag", "forge:jear_runes");
			object.addProperty("Block X+2 Z+2 ID or Tag", "rituals_of_the_wilds:candle_glass_jar");
			object.addProperty("Block X-2 Z+2 ID or Tag", "rituals_of_the_wilds:candle_glass_jar");
			object.addProperty("Block X+2 Z-2 ID or Tag", "rituals_of_the_wilds:candle_glass_jar");
			object.addProperty("Block X-2 Z-2 ID or Tag", "rituals_of_the_wilds:candle_glass_jar");
			...
			object.addProperty("Replacment Block Z-3 ID", "minecraft:air");
			object.addProperty("Replacment Block X+2 Z+2 ID", "rituals_of_the_wilds:glass_jar");
			object.addProperty("Replacment Block X-2 Z+2 ID", "rituals_of_the_wilds:glass_jar");
			object.addProperty("Replacment Block X+2 Z-2 ID", "rituals_of_the_wilds:glass_jar");
			object.addProperty("Replacment Block X-2 Z-2 ID", "rituals_of_the_wilds:glass_jar");
			...
			object.addProperty("Result command", "ritualrunetrysecond");
			object.addProperty("Info about result", "You can use any color of ink in any of the five rune placed during this ritual. However, the central rune will produce a unique effect with level two based on the color of central rune.");
			{
