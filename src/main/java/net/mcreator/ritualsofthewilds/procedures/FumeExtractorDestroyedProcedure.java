...
public class FumeExtractorDestroyedProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == RitualsOfTheWildsModBlocks.FUME_EXTRACTOR.get()) {
			if (world instanceof ServerLevel _level)
				_level.getServer().getCommands().performPrefixedCommand(
						...
						"kill @e[type=minecraft:item_display,distance=..1,tag=fume_extracting]");
		}
	}
}
