...
public class GenerateRitualWeatherClearProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.RITUALRECIPESREGENERATE.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Rituals/eng"), File.separator + "9ritual.json");
			try {
			...
			object.addProperty("Ritual Name", "World Type Ritual: Clear weather");
			object.addProperty("May Spawn In Ritual Scroll", true);
			object.addProperty("Must Read Scroll First", true);
			object.addProperty("Central Block ID or Tag", "rituals_of_the_wilds:ash_jear");
			...
			object.addProperty("Block X+3 ID or Tag", "rituals_of_the_wilds:ash_feoh");
			object.addProperty("Block X-3 ID or Tag", "rituals_of_the_wilds:ash_feoh");
			object.addProperty("Block Z+3 ID or Tag", "rituals_of_the_wilds:ash_feoh");
			object.addProperty("Block Z-3 ID or Tag", "rituals_of_the_wilds:ash_feoh");
			object.addProperty("Block X+2 Z+2 ID or Tag", "rituals_of_the_wilds:ash_feoh");
			object.addProperty("Block X-2 Z+2 ID or Tag", "rituals_of_the_wilds:ash_feoh");
			object.addProperty("Block X+2 Z-2 ID or Tag", "rituals_of_the_wilds:ash_feoh");
			object.addProperty("Block X-2 Z-2 ID or Tag", "rituals_of_the_wilds:ash_feoh");
			...
			object.addProperty("Result command", "weather clear");
			object.addProperty("Info about result", "If there is rain or thunder it will make sky clear again!");
			{
