...
public class GenerateAlchemyRecipe11Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.ALCHEMYCAULDRONRECIPESREGEN.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Alchemy_Cauldron/eng"), File.separator + "15alchemyrecipe.json");
			try {
			...
			object.addProperty("Name for Alchemy Scroll", "Alchemy Recipe: Lapis Ore Pure Crushing");
			...
			object.addProperty("Replacement Block X+2 Y+2 Z-2 ID", "");
			object.addProperty("Replacement Block X-2 Y+2 Z-2 ID", "");
			object.addProperty("Ingredient ID or Tag 1", "forge:lapis_ore");
			...
			object.addProperty("Result item ID", "minecraft:lapis_lazuli");
