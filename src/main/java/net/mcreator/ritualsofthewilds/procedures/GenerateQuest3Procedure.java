...
public class GenerateQuest3Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENQUESTS.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/quests/eng"), File.separator + "chernobog_color_dust_give.json");
			try {
			...
			object.addProperty("Quest name", "Colors of the Void");
			object.addProperty("Text Line", "Bring Chernobog 16 Color DustsHe seeks to drain their light and twist it into something far more fitting for the realm of shadows.");
			...
			object.addProperty("Quest Item ID or Tag", "rituals_of_the_wilds:color_dust");
			object.addProperty("Quest Item Count", 16);
