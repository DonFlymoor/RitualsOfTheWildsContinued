...
public class GenerateNormalDialogue3Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_33.json");
			try {
			...
			object.addProperty("Text Line",
					"Leshy... yes. I remember his voice before it barked through leaves. We were not enemies \u2014 not in the way you think. He slowed entropy. I fed it. Both necessary. Two ends of the same breath. But he chose to fall. To root himself. Now he hides behind branches, prays through mushrooms. He fears what we are. He would save the world from rot. I would teach it how to thrive in decay.");
			object.addProperty("First Answer Text Line", "\u300B Is there no peace between you?");
			...
			object.addProperty("First Answer Result Command", "tellraw @s \"<Chernobog> Peace is stagnation. There is only movement \u2014 forward, or into the earth.\"");
			...
			object.addProperty("Second Answer Text Line", "\u300B You sound almost... nostalgic.");
			...
			object.addProperty("Second Answer Result Command", "tellraw @s \"<Chernobog> Even gods can mourn the shape of old songs.\"");
