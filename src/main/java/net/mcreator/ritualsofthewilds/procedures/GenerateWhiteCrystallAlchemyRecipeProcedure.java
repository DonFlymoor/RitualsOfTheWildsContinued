...
public class GenerateWhiteCrystallAlchemyRecipeProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.ALCHEMYCAULDRONRECIPESREGEN.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Alchemy_Cauldron/eng"), File.separator + "4alchemyrecipe.json");
			try {
			...
			object.addProperty("Name for Alchemy Scroll", "Alchemy Recipe: White Crystal Shard");
			...
			object.addProperty("Replacement Block X+2 Y+2 Z-2 ID", "");
			object.addProperty("Replacement Block X-2 Y+2 Z-2 ID", "");
			object.addProperty("Ingredient ID or Tag 1", "forge:white_dye");
			object.addProperty("Ingredient ID or Tag 2", "forge:white_dye");
			object.addProperty("Ingredient ID or Tag 3", "forge:white_dye");
			object.addProperty("Ingredient ID or Tag 4", "forge:white_dye");
			...
			object.addProperty("Result item ID", "rituals_of_the_wilds:white_crystal_shard");
