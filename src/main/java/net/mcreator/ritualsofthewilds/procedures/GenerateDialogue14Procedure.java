...
public class GenerateDialogue14Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_14.json");
			try {
			...
			object.addProperty("Text Line", "Once, I was worshipped. Now I am remembered in shivers and curses. But names do not matter \u2014 only power endures.");
			object.addProperty("First Answer Text Line", "\u300B I want to understand your power.");
			...
			object.addProperty("First Answer Result Dialogue Number", 15);
			...
			object.addProperty("Second Answer Text Line", "\u300B Then you\u2019ve already lost. Forgotten gods are just shadows.");
			...
			object.addProperty("Second Answer Result Command", "summon minecraft:lightning_bolt ~ ~2 ~");
