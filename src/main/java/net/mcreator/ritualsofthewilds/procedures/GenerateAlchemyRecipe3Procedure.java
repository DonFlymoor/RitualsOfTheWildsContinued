...
public class GenerateAlchemyRecipe3Procedure {
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.ALCHEMYCAULDRONRECIPESREGEN.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Alchemy_Cauldron/eng"), File.separator + "7alchemyrecipe.json");
			try {
			...
			object.addProperty("Name for Alchemy Scroll", "Alchemy Recipe: Spirit Ink Bottle");
			...
			object.addProperty("Replacement Block X+2 Y+2 Z-2 ID", "");
			object.addProperty("Replacement Block X-2 Y+2 Z-2 ID", "");
			object.addProperty("Ingredient ID or Tag 1", "rituals_of_the_wilds:spiritbloom");
			object.addProperty("Ingredient ID or Tag 2", "minecraft:white_dye");
			object.addProperty("Ingredient ID or Tag 3", "minecraft:white_dye");
			object.addProperty("Ingredient ID or Tag 4", "minecraft:white_dye");
			...
			object.addProperty("Result item ID", "rituals_of_the_wilds:spirit_ink_bottle");
