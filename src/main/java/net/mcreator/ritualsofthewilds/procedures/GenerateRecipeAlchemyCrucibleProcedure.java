...
public class GenerateRecipeAlchemyCrucibleProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.ALCHEMYCAULDRONRECIPESREGEN.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Alchemy_Cauldron/eng"), File.separator + "1alchemyrecipe.json");
			try {
			...
			object.addProperty("Must Read Scroll First", false);
			object.addProperty("Name for Alchemy Scroll", "Alchemy Recipe: Inscribing Quill");
			...
			object.addProperty("Replacement Block X+2 Y+2 Z-2 ID", "");
			object.addProperty("Replacement Block X-2 Y+2 Z-2 ID", "");
			object.addProperty("Ingredient ID or Tag 1", "minecraft:feather");
			object.addProperty("Ingredient ID or Tag 2", "minecraft:feather");
			object.addProperty("Ingredient ID or Tag 3", "minecraft:feather");
			object.addProperty("Ingredient ID or Tag 4", "minecraft:feather");
			object.addProperty("Ingredient ID or Tag 5", "minecraft:iron_ingot");
			object.addProperty("Ingredient ID or Tag 6", "minecraft:iron_ingot");
			object.addProperty("Ingredient ID or Tag 7", "minecraft:iron_ingot");
			object.addProperty("Ingredient ID or Tag 8", "minecraft:iron_ingot");
			...
			object.addProperty("Result item ID", "rituals_of_the_wilds:inscribing_quill");
