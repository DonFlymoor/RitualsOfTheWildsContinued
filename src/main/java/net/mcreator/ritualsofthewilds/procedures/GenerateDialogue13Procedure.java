...
public class GenerateDialogue13Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_13.json");
			try {
			...
			object.addProperty("Text Line", "Proving yourself is a blade that cuts both ways. You may bleed before you impress me.");
			object.addProperty("First Answer Text Line", "\u300B I\u2019m not afraid of pain.");
			...
			object.addProperty("First Answer Result Quest Give ID", "chernobog_first_kill");
			object.addProperty("First Answer Sound", "playsound rituals_of_the_wilds:chernobog_living hostile @s ~ ~ ~ 100 0.75");
			object.addProperty("Second Answer Text Line", "\u300B Maybe I\u2019ve overstepped.");
