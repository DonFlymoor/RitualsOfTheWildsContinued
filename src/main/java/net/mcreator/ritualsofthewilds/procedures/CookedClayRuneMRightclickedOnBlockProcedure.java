...
public class CookedClayRuneMRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if ((world.getBlockState(BlockPos.containing(x, y, z)).canOcclude() == true || world.getBlockState(BlockPos.containing(x, y, z)).isFaceSturdy(world, BlockPos.containing(x, y, z), Direction.UP) == true)
			...
			itemstack.shrink(1);
			world.setBlock(BlockPos.containing(x, y + 1, z), RitualsOfTheWildsModBlocks.COOKED_CLAY_RUNE_M_STANDING.get().defaultBlockState(), 3);
			{
