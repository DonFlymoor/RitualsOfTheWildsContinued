...
public class GenerateAlchemyRecipe1Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.ALCHEMYCAULDRONRECIPESREGEN.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Alchemy_Cauldron/eng"), File.separator + "5alchemyrecipe.json");
			try {
			...
			object.addProperty("Name for Alchemy Scroll", "Alchemy Recipe: Blue Ice Transmutation");
			...
			object.addProperty("Replacement Block X+2 Y+2 Z-2 ID", "");
			object.addProperty("Replacement Block X-2 Y+2 Z-2 ID", "");
			object.addProperty("Ingredient ID or Tag 1", "minecraft:ice");
			object.addProperty("Ingredient ID or Tag 2", "minecraft:ice");
			object.addProperty("Ingredient ID or Tag 3", "rituals_of_the_wilds:frost_moss");
			object.addProperty("Ingredient ID or Tag 4", "rituals_of_the_wilds:frost_moss");
			...
			object.addProperty("Result item ID", "minecraft:blue_ice");
			object.addProperty("Min/Fixed result item give count", 1);
			object.addProperty("Max result item give count", 2);
			{
