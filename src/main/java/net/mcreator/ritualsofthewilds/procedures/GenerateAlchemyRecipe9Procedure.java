...
public class GenerateAlchemyRecipe9Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.ALCHEMYCAULDRONRECIPESREGEN.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Alchemy_Cauldron/eng"), File.separator + "13alchemyrecipe.json");
			try {
			...
			object.addProperty("Name for Alchemy Scroll", "Alchemy Recipe: Ink Sac -> Glow Ink Sac Transmutation");
			...
			object.addProperty("Block X-3 ID Or Tag", "rituals_of_the_wilds:stone_rune_m_standing");
			object.addProperty("Block X+3 ID Or Tag", "rituals_of_the_wilds:stone_rune_m_standing");
			object.addProperty("Block Z-3 ID Or Tag", "rituals_of_the_wilds:stone_rune_c_standing");
			object.addProperty("Block Z+3 ID Or Tag", "rituals_of_the_wilds:stone_rune_c_standing");
			...
			object.addProperty("Ingredient ID or Tag 2", "minecraft:glowstone_dust");
			...
			object.addProperty("Result item ID", "minecraft:glow_ink_sac");
