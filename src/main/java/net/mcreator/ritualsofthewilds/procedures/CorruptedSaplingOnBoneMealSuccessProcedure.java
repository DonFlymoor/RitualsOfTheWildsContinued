...
public class CorruptedSaplingOnBoneMealSuccessProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (world.getBlockState(BlockPos.containing(x, y + 1, z)).canOcclude() == false && world.getBlockState(BlockPos.containing(x, y + 2, z)).canOcclude() == false && world.getBlockState(BlockPos.containing(x, y + 3, z)).canOcclude() == false
			...
			if (Math.random() <= 0.2) {
				random = Math.round(Mth.nextDouble(RandomSource.create(), 1, 8));
				if (random == 1) {
					...
					if (world instanceof ServerLevel _serverworld) {
						...
						if (template != null) {
							template.placeInWorld(_serverworld, BlockPos.containing(x - 7, y - 1, z - 6), BlockPos.containing(x - 7, y - 1, z - 6),
									new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
						}
					}
				} else if (random == 3) {
					...
					if (world instanceof ServerLevel _serverworld) {
						...
						if (template != null) {
							template.placeInWorld(_serverworld, BlockPos.containing(x - 5, y - 1, z - 9), BlockPos.containing(x - 5, y - 1, z - 9),
									new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
						}
					}
				} else if (random == 5) {
					...
					if (world instanceof ServerLevel _serverworld) {
						...
						if (template != null) {
							template.placeInWorld(_serverworld, BlockPos.containing(x - 8, y - 1, z - 4), BlockPos.containing(x - 8, y - 1, z - 4),
									new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
						}
					}
				} else if (random == 7) {
					...
					if (world instanceof ServerLevel _serverworld) {
						...
						if (template != null) {
							template.placeInWorld(_serverworld, BlockPos.containing(x - 3, y - 1, z - 4), BlockPos.containing(x - 3, y - 1, z - 4),
									new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
						}
					}
				} else if (random == 8) {
					...
					if (world instanceof ServerLevel _serverworld) {
						...
						if (template != null) {
							template.placeInWorld(_serverworld, BlockPos.containing(x - 4, y - 1, z - 7), BlockPos.containing(x - 4, y - 1, z - 7),
									new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
						}
					}
				}
