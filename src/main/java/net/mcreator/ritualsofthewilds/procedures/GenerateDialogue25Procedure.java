...
public class GenerateDialogue25Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_25.json");
			try {
			...
			object.addProperty("Text Line", "These are the fragments I require. Not for their power, but for what they represent \u2014 precision, rarity, and will.");
			object.addProperty("First Answer Text Line", "\u300B Offer 16 Color Dusts");
			object.addProperty("First Answer Quest Requirement", "chernobog_color_dust_give");
			object.addProperty("First Answer Quest Requirement State", 3);
			object.addProperty("First Answer Result Dialogue Number", 0);
			object.addProperty("First Answer Result Command", "");
			object.addProperty("First Answer Result Quest Give ID", "chernobog_color_dust_give");
			object.addProperty("First Answer Result Command Player, World or Entity Executed", 0);
			object.addProperty("First Answer Sound", "");
			object.addProperty("Second Answer Text Line", "\u300B Offer 1 Storm Ink Bottle");
			object.addProperty("Second Answer Quest Requirement", "chernobog_storm_ink_bottle_give");
			...
			object.addProperty("Second Answer Result Quest Give ID", "chernobog_storm_ink_bottle_give");
			object.addProperty("Second Answer Sound", "");
			object.addProperty("Second Answer Result Command Player, World or Entity Executed", 0);
			object.addProperty("Third Answer Text Line", "\u300B Offer 1 Moonlight Ink Bottle");
			object.addProperty("Third Answer Quest Requirement", "chernobog_moonlight_ink_bottle_give");
			...
			object.addProperty("Third Answer Result Quest Give ID", "chernobog_moonlight_ink_bottle_give");
			object.addProperty("Third Answer Sound", "");
			object.addProperty("Third Answer Result Command Player, World or Entity Executed", 0);
			object.addProperty("Fourth Answer Text Line", "\u300B Offer 8 Tied Dried Void Roots");
			object.addProperty("Fourth Answer Quest Requirement", "chernobog_tied_dried_voidroot_give");
			object.addProperty("Fourth Answer Quest Requirement State", 3);
			object.addProperty("Fourth Answer Result Dialogue Number", 0);
			object.addProperty("Fourth Answer Result Command", "");
			object.addProperty("Fourth Answer Result Quest Give ID", "chernobog_tied_dried_voidroot_give");
