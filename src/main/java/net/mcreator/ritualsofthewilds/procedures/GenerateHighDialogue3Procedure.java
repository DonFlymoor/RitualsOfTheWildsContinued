...
public class GenerateHighDialogue3Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_52.json");
			try {
			...
			object.addProperty("Text Line", "You are no longer shaped by the world. You shape it now, in small ways \u2014 in wrong ways. That is the first mark of the divine. You are not like me. But you're not like them anymore, either.");
