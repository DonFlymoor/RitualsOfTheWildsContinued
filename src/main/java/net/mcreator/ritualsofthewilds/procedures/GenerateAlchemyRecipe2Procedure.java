...
public class GenerateAlchemyRecipe2Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.ALCHEMYCAULDRONRECIPESREGEN.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Alchemy_Cauldron/eng"), File.separator + "6alchemyrecipe.json");
			try {
			...
			object.addProperty("Name for Alchemy Scroll", "Alchemy Recipe: Ember Ink Bottle");
			...
			object.addProperty("Cauldron Fill Type", 1);
			...
			object.addProperty("Replacement Block X+2 Y+2 Z-2 ID", "");
			object.addProperty("Replacement Block X-2 Y+2 Z-2 ID", "");
			object.addProperty("Ingredient ID or Tag 1", "minecraft:magma_block");
			object.addProperty("Ingredient ID or Tag 2", "minecraft:magma_block");
			object.addProperty("Ingredient ID or Tag 3", "rituals_of_the_wilds:dried_ember_leaf_berry");
			object.addProperty("Ingredient ID or Tag 4", "rituals_of_the_wilds:ember_leaf_berry");
			object.addProperty("Ingredient ID or Tag 5", "rituals_of_the_wilds:empty_ink_bottle");
			...
			object.addProperty("Result item ID", "rituals_of_the_wilds:ember_ink_bottle");
