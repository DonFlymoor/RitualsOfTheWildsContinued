...
public class GenerateQuest4Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENQUESTS.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/quests/eng"), File.separator + "chernobog_storm_ink_bottle_give.json");
			try {
			...
			object.addProperty("Quest name", "Ink of the Tempest");
			object.addProperty("Text Line", "Chernobog calls for a Storm Ink Bottle\u2014essence of thunder and void. Deliver it, and he shall stir the skies with forgotten power.");
			...
			object.addProperty("Quest Item ID or Tag", "rituals_of_the_wilds:storm_ink_bottle");
