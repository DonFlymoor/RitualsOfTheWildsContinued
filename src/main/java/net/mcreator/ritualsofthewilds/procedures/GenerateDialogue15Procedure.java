...
public class GenerateDialogue15Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_15.json");
			try {
			...
			object.addProperty("Text Line", "Understanding comes at a cost. Sacrifice. Loyalty. Blood. Are you prepared to give any of these?");
			object.addProperty("First Answer Text Line", "\u300B I will give what is required.");
			object.addProperty("First Answer Quest Requirement", "chernobog_first_give");
			...
			object.addProperty("First Answer Result Quest Give ID", "chernobog_first_give");
			object.addProperty("First Answer Sound", "playsound rituals_of_the_wilds:chernobog_living hostile @s ~ ~ ~ 100 0.75");
			object.addProperty("Second Answer Text Line", "\u300B Not yet. But soon.");
