...
public class GenerateDeliveryQuest2Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENQUESTS.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/quests/eng"), File.separator + "chernobog_honey_stone_delivery.json");
			try {
			...
			object.addProperty("Quest name", "Sweetness for Shadows");
			object.addProperty("Text Line", "The Elder hands you Honey Stones, a rare treat favored by Chernobog alone. Deliver them quickly\u2014his patience fades faster than his mercy.");
			...
			object.addProperty("Quest Item ID or Tag", "rituals_of_the_wilds:honey_stones");
			object.addProperty("Quest Item Count", 8);
			object.addProperty("Quest Reward Item ID", "rituals_of_the_wilds:eldritch_ink_bottle");
