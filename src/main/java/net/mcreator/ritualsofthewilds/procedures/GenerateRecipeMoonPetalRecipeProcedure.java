...
public class GenerateRecipeMoonPetalRecipeProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.RITUALRECIPESREGENERATE.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Rituals/eng"), File.separator + "17ritual.json");
			try {
			...
			object.addProperty("Ritual Name", "Recipe Type Ritual: Moonpetal");
			object.addProperty("May Spawn In Ritual Scroll", true);
			object.addProperty("Must Read Scroll First", true);
			object.addProperty("Central Block ID or Tag", "rituals_of_the_wilds:blood_feoh");
			object.addProperty("Offhand Item ID or Tag", "rituals_of_the_wilds:suns_tear");
			...
			object.addProperty("Block X+2 ID or Tag", "rituals_of_the_wilds:blood_feoh");
			object.addProperty("Block X-2 ID or Tag", "rituals_of_the_wilds:blood_feoh");
			object.addProperty("Block Z+2 ID or Tag", "rituals_of_the_wilds:blood_feoh");
			object.addProperty("Block Z-2 ID or Tag", "rituals_of_the_wilds:blood_feoh");
			...
			object.addProperty("Replacment Block Z-2 ID", "minecraft:air");
			object.addProperty("Fixed or Random Amount", true);
			object.addProperty("Min/Fixed result item give count", 1);
			object.addProperty("Max result item give count", 4);
			object.addProperty("Result item ID", "rituals_of_the_wilds:moonpetal");
			{
