...
public class GenerateGoodDialoguesProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_4.json");
			try {
			...
			object.addProperty("Text Line", "You return again... and again. Not for answers. Not for light. But for me. There is rot beneath your nails now \u2014 I can smell it. You\u2019ve begun to understand.");
			object.addProperty("First Answer Text Line", "\u300B You said gods aren\u2019t good or evil. What are they, then?");
			object.addProperty("First Answer Quest Requirement", "");
			object.addProperty("First Answer Quest Requirement State", 1);
			object.addProperty("First Answer Result Dialogue Number", 41);
			...
			object.addProperty("Second Answer Text Line", "\u300B What lies beneath the shrines?");
			object.addProperty("Second Answer Quest Requirement", "");
			object.addProperty("Second Answer Quest Requirement State", 1);
			object.addProperty("Second Answer Result Dialogue Number", 42);
			...
			object.addProperty("Third Answer Text Line", "\u300B I came to listen.");
			object.addProperty("Third Answer Quest Requirement", "");
			object.addProperty("Third Answer Quest Requirement State", 1);
			object.addProperty("Third Answer Result Dialogue Number", 43);
