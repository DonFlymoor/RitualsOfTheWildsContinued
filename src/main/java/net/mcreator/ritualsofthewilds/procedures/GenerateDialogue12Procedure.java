...
public class GenerateDialogue12Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_12.json");
			try {
			...
			object.addProperty("Text Line", "I am the breath between death and remembrance. I am what gods fear when they grow old.");
			object.addProperty("First Answer Text Line", "\u300B You speak like a god. Are you one?");
			object.addProperty("First Answer Quest Requirement", "");
			object.addProperty("First Answer Quest Requirement State", 1);
			object.addProperty("First Answer Result Dialogue Number", 14);
			...
			object.addProperty("Second Answer Text Line", "\u300B Then why are you here, hiding in this place?");
			...
			object.addProperty("Second Answer Result Command", "tellraw @s \"<Chernobog> To one such as I, this is not hiding \u2014 it is waiting. The sun hides each night too, mortal. Yet it always returns... burning.\"");
