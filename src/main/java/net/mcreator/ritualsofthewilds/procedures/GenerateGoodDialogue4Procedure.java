...
public class GenerateGoodDialogue4Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_43.json");
			try {
			...
			object.addProperty("Text Line",
					"Silence is rare. Most come begging or bargaining. You do neither. So I will tell you something: There is no fate. No prophecy. No divine justice. Only momentum \u2014 what survives, survives. What changes, rules. Even gods get eaten by time. I won\u2019t be one of them.");
			object.addProperty("First Answer Text Line", "*Leave*");
