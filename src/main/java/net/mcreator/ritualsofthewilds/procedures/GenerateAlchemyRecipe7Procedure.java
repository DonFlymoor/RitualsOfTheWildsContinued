...
public class GenerateAlchemyRecipe7Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.ALCHEMYCAULDRONRECIPESREGEN.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Alchemy_Cauldron/eng"), File.separator + "11alchemyrecipe.json");
			try {
			...
			object.addProperty("Name for Alchemy Scroll", "Alchemy Recipe: Redstone dust -> Glowstone dust Transmutation");
			...
			object.addProperty("Block X-3 ID Or Tag", "rituals_of_the_wilds:wooden_rune_base_standing");
			object.addProperty("Block X+3 ID Or Tag", "rituals_of_the_wilds:wooden_rune_base_standing");
			object.addProperty("Block Z-3 ID Or Tag", "rituals_of_the_wilds:wooden_rune_base_standing");
			object.addProperty("Block Z+3 ID Or Tag", "rituals_of_the_wilds:wooden_rune_base_standing");
			...
			object.addProperty("Replacement Block X+2 Y+2 Z-2 ID", "");
			object.addProperty("Replacement Block X-2 Y+2 Z-2 ID", "");
			object.addProperty("Ingredient ID or Tag 1", "minecraft:redstone");
			...
			object.addProperty("Result item ID", "minecraft:glowstone_dust");
