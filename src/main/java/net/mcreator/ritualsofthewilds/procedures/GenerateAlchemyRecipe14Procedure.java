...
public class GenerateAlchemyRecipe14Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.ALCHEMYCAULDRONRECIPESREGEN.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Alchemy_Cauldron/eng"), File.separator + "18alchemyrecipe.json");
			try {
			...
			object.addProperty("Name for Alchemy Scroll", "Alchemy Recipe: Copper Ore Pure Crushing");
			...
			object.addProperty("Replacement Block X+2 Y+2 Z-2 ID", "");
			object.addProperty("Replacement Block X-2 Y+2 Z-2 ID", "");
			object.addProperty("Ingredient ID or Tag 1", "forge:copper_ore");
			...
			object.addProperty("Result item ID", "minecraft:raw_copper");
			object.addProperty("Min/Fixed result item give count", 12);
			object.addProperty("Max result item give count", 36);
			{
