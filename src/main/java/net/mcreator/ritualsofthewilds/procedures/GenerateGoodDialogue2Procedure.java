...
public class GenerateGoodDialogue2Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_41.json");
			try {
			...
			object.addProperty("Text Line",
					"\u2018God\u2019 is a word you wrap around the unknowable, like gauze over rot. We are not good. Not evil. We are \u2014 with all the weight of that. When I unmake, it is not hatred. When Leshy heals, it is not mercy. These are acts. Functions. You call fire cruel when it devours, but worship it when it warms your home. We are fire.");
			object.addProperty("First Answer Text Line", "\u300B But you corrupt.");
			...
			object.addProperty("First Answer Result Command", "tellraw @s \"<Chernobog> I reveal. What you call corruption is just truth that won't fit your skin.\"");
			...
			object.addProperty("Second Answer Text Line", "\u300B Then what am I becoming?");
			...
			object.addProperty("Second Answer Result Command", "tellraw @s \"<Chernobog> Closer. That\u2019s all that matters.\"");
