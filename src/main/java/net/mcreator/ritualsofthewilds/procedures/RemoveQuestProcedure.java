...
public class RemoveQuestProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if (file.exists() == true) {
			if ((((new Object() {
			...
			}.getEntity()).getCapability(RitualsOfTheWildsModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new RitualsOfTheWildsModVariables.PlayerVariables())).firstquestid).equals(StringArgumentType.getString(arguments, "quest_id"))) {
				{
					String _setval = "";
					(new Object() {
						public Entity getEntity() {
				...
				if ((((new Object() {
				...
				}.getEntity()).getCapability(RitualsOfTheWildsModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new RitualsOfTheWildsModVariables.PlayerVariables())).secondquestid).equals(StringArgumentType.getString(arguments, "quest_id"))) {
					{
						String _setval = "";
						(new Object() {
							public Entity getEntity() {
					...
					if ((((new Object() {
					...
					}.getEntity()).getCapability(RitualsOfTheWildsModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new RitualsOfTheWildsModVariables.PlayerVariables())).thirdquestid)
							.equals(StringArgumentType.getString(arguments, "quest_id"))) {
						{
							String _setval = "";
							(new Object() {
								public Entity getEntity() {
						...
						if ((((new Object() {
						...
						}.getEntity()).getCapability(RitualsOfTheWildsModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new RitualsOfTheWildsModVariables.PlayerVariables())).fourthquestid)
								.equals(StringArgumentType.getString(arguments, "quest_id"))) {
							{
								String _setval = "";
								(new Object() {
							...
							if ((((new Object() {
							...
							}.getEntity()).getCapability(RitualsOfTheWildsModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new RitualsOfTheWildsModVariables.PlayerVariables())).fifthquestid)
									.equals(StringArgumentType.getString(arguments, "quest_id"))) {
								{
									String _setval = "";
									(new Object() {
								...
								if (entity instanceof Player _player && !_player.level().isClientSide())
									_player.displayClientMessage(Component.literal("No quest been found with this quest id in this entity"), false);
							}
						}
					}
				}
