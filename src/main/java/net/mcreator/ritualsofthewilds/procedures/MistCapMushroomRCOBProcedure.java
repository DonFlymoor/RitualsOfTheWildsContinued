...
public class MistCapMushroomRCOBProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, ItemStack itemstack) {
		if ((world.getBlockState(BlockPos.containing(x, y, z))).is(BlockTags.create(new ResourceLocation("forge:herbs_growth_possible"))) == true) {
			if ((world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == Blocks.AIR) {
				world.setBlock(BlockPos.containing(x, y + 1, z), RitualsOfTheWildsModBlocks.MISTCAP_MUSHROOM_1.get().defaultBlockState(), 3);
				itemstack.shrink(1);
			}
		}
	}
