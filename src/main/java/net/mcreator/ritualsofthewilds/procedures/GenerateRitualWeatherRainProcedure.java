...
public class GenerateRitualWeatherRainProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.RITUALRECIPESREGENERATE.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Rituals/eng"), File.separator + "10ritual.json");
			try {
			...
			object.addProperty("Ritual Name", "World Type Ritual: Rain");
			object.addProperty("May Spawn In Ritual Scroll", true);
			object.addProperty("Must Read Scroll First", true);
			object.addProperty("Central Block ID or Tag", "rituals_of_the_wilds:tide_jear");
			...
			object.addProperty("Block X+3 ID or Tag", "rituals_of_the_wilds:tide_feoh");
			object.addProperty("Block X-3 ID or Tag", "rituals_of_the_wilds:tide_feoh");
			object.addProperty("Block Z+3 ID or Tag", "rituals_of_the_wilds:tide_feoh");
			object.addProperty("Block Z-3 ID or Tag", "rituals_of_the_wilds:tide_feoh");
			object.addProperty("Block X+2 Z+2 ID or Tag", "rituals_of_the_wilds:tide_feoh");
			object.addProperty("Block X-2 Z+2 ID or Tag", "rituals_of_the_wilds:tide_feoh");
			object.addProperty("Block X+2 Z-2 ID or Tag", "rituals_of_the_wilds:tide_feoh");
			object.addProperty("Block X-2 Z-2 ID or Tag", "rituals_of_the_wilds:tide_feoh");
			...
			object.addProperty("Result command", "weather rain");
			object.addProperty("Info about result", "If there is clear sky you can make it rain.");
			{
