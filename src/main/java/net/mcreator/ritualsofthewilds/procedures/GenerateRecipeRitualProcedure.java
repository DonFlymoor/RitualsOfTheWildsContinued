...
public class GenerateRecipeRitualProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.RITUALRECIPESREGENERATE.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Rituals/eng"), File.separator + "2ritual.json");
			try {
			...
			object.addProperty("Ritual Name", "Recipe Type Ritual: Storm Ink Bottle");
			object.addProperty("May Spawn In Ritual Scroll", true);
			object.addProperty("Must Read Scroll First", true);
			object.addProperty("Central Block ID or Tag", "rituals_of_the_wilds:blue_candle_glass_jar");
			...
			object.addProperty("Weather Type needed", 2);
			object.addProperty("Ritual Difficulty Level", 1);
			object.addProperty("Block X+2 ID or Tag", "rituals_of_the_wilds:tide_yr");
			object.addProperty("Block X-2 ID or Tag", "rituals_of_the_wilds:tide_yr");
			object.addProperty("Block Z+2 ID or Tag", "rituals_of_the_wilds:tide_feoh");
			object.addProperty("Block Z-2 ID or Tag", "rituals_of_the_wilds:tide_feoh");
			...
			object.addProperty("Result item ID", "rituals_of_the_wilds:storm_ink_bottle");
			{
