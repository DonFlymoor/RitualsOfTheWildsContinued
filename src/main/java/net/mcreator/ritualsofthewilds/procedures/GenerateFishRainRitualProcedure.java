...
public class GenerateFishRainRitualProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.RITUALRECIPESREGENERATE.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Rituals/eng"), File.separator + "28ritual.json");
			try {
			...
			object.addProperty("Ritual Name", "Fun Type Ritual: Fish Rain!");
			object.addProperty("May Spawn In Ritual Scroll", true);
			object.addProperty("Must Read Scroll First", true);
			object.addProperty("Central Block ID or Tag", "rituals_of_the_wilds:stone_rune_x_standing");
			object.addProperty("Offhand Item ID or Tag", "minecraft:cod");
			...
			object.addProperty("Block X+3 ID or Tag", "rituals_of_the_wilds:tide_yr");
			object.addProperty("Block X-3 ID or Tag", "rituals_of_the_wilds:tide_yr");
			object.addProperty("Block Z+3 ID or Tag", "rituals_of_the_wilds:tide_jear");
			object.addProperty("Block Z-3 ID or Tag", "rituals_of_the_wilds:tide_jear");
			object.addProperty("Block X+2 Z+2 ID or Tag", "rituals_of_the_wilds:stone_rune_u_standing");
			object.addProperty("Block X-2 Z+2 ID or Tag", "rituals_of_the_wilds:stone_rune_u_standing");
			object.addProperty("Block X+2 Z-2 ID or Tag", "rituals_of_the_wilds:stone_rune_l_standing");
			object.addProperty("Block X-2 Z-2 ID or Tag", "rituals_of_the_wilds:stone_rune_l_standing");
			...
			object.addProperty("Result command", "function rituals_of_the_wilds:fishrain");
			object.addProperty("Info about result", "Summons few cod's in air!");
			{
