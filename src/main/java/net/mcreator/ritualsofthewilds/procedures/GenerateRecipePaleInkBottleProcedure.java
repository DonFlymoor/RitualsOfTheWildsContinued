...
public class GenerateRecipePaleInkBottleProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.RITUALRECIPESREGENERATE.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Rituals/eng"), File.separator + "12ritual.json");
			try {
			...
			object.addProperty("Ritual Name", "Recipe Type Ritual: Pale Ink Bottle");
			...
			object.addProperty("Block X+2 ID or Tag", "rituals_of_the_wilds:ash_yr");
			object.addProperty("Block X-2 ID or Tag", "rituals_of_the_wilds:ash_yr");
			object.addProperty("Block Z+2 ID or Tag", "rituals_of_the_wilds:blood_yr");
			object.addProperty("Block Z-2 ID or Tag", "rituals_of_the_wilds:blood_yr");
			...
			object.addProperty("Result item ID", "rituals_of_the_wilds:pale_ink_bottle");
			{
