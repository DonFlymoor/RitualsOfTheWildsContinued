...
public class GenerateIngredientsFumeExtractorProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENINGREDIENTSTAB.get() == true) {
			...
			try {
				...
				{
					filebw.write("rituals_of_the_wilds:fumes_bottle");
					filebw.newLine();
				}
				{
					filebw.write("minecraft:poppy");
					filebw.newLine();
				}
				{
					filebw.write("minecraft:dandelion");
					filebw.newLine();
				}
				{
					filebw.write("minecraft:cornflower");
					filebw.newLine();
				}
				{
					filebw.write("rituals_of_the_wilds:old_ceramic_pot");
					filebw.newLine();
				}
				{
					filebw.write("rituals_of_the_wilds:void_dust");
					filebw.newLine();
				}
				filebw.close();
				filewriter.close();
