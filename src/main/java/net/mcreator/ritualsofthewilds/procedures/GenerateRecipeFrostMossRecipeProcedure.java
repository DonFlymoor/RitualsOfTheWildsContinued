...
public class GenerateRecipeFrostMossRecipeProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.RITUALRECIPESREGENERATE.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Rituals/eng"), File.separator + "16ritual.json");
			try {
			...
			object.addProperty("Ritual Name", "Recipe Type Ritual: Frost moss");
			object.addProperty("May Spawn In Ritual Scroll", true);
			object.addProperty("Must Read Scroll First", true);
			object.addProperty("Central Block ID or Tag", "minecraft:vine");
			object.addProperty("Offhand Item ID or Tag", "rituals_of_the_wilds:cryorite_powder");
			...
			object.addProperty("Block X+2 ID or Tag", "rituals_of_the_wilds:frost_feoh");
			object.addProperty("Block X-2 ID or Tag", "rituals_of_the_wilds:frost_feoh");
			object.addProperty("Block Z+2 ID or Tag", "rituals_of_the_wilds:frost_feoh");
			object.addProperty("Block Z-2 ID or Tag", "rituals_of_the_wilds:frost_feoh");
			...
			object.addProperty("Result item ID", "rituals_of_the_wilds:frost_moss");
			{
