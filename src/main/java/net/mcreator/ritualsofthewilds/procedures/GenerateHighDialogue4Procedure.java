...
public class GenerateHighDialogue4Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_53.json");
			try {
			...
			object.addProperty("Text Line",
					"Prophecy is a game for hollow gods and frightened kings. I see no future. I taste it \u2014 in the rot, in the roots, in your skin. And what I taste is change. Not peace. Not ruin. Just... more. If you walk further, the world will split. It may not survive what you become. But you will.");
