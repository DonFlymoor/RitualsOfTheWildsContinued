...
public class GenerateRepairDamagedAnvilProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.RITUALRECIPESREGENERATE.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Rituals/eng"), File.separator + "26ritual.json");
			try {
			...
			object.addProperty("Ritual Name", "Repair Type Ritual: Damaged Anvil");
			object.addProperty("May Spawn In Ritual Scroll", true);
			object.addProperty("Must Read Scroll First", true);
			object.addProperty("Central Block ID or Tag", "minecraft:damaged_anvil");
			object.addProperty("Offhand Item ID or Tag", "minecraft:iron_ingot");
			...
			object.addProperty("Block X-2 ID or Tag", "rituals_of_the_wilds:ember_iar");
			object.addProperty("Block Z+2 ID or Tag", "rituals_of_the_wilds:ember_jear");
			object.addProperty("Block Z-2 ID or Tag", "rituals_of_the_wilds:ember_yr");
			object.addProperty("Central Block Replacment Type", 3);
			object.addProperty("Central Block Replacment ID", "minecraft:chipped_anvil");
			...
			object.addProperty("Result item ID", "minecraft:air");
			{
