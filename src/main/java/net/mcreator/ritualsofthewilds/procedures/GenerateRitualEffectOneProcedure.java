...
public class GenerateRitualEffectOneProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.RITUALRECIPESREGENERATE.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Rituals/eng"), File.separator + "13ritual.json");
			try {
			...
			object.addProperty("Ritual Name", "Effect Type Ritual: First Level Rune effect");
			...
			object.addProperty("Block Z-3 ID or Tag", "forge:jear_runes");
			object.addProperty("Block X+2 Z+2 ID or Tag", "rituals_of_the_wilds:small_candle_glass_jar");
			object.addProperty("Block X-2 Z+2 ID or Tag", "rituals_of_the_wilds:small_candle_glass_jar");
			object.addProperty("Block X+2 Z-2 ID or Tag", "rituals_of_the_wilds:small_candle_glass_jar");
			object.addProperty("Block X-2 Z-2 ID or Tag", "rituals_of_the_wilds:small_candle_glass_jar");
			...
			object.addProperty("Replacment Block Z-3 ID", "minecraft:air");
			object.addProperty("Replacment Block X+2 Z+2 ID", "rituals_of_the_wilds:small_glass_jar");
			object.addProperty("Replacment Block X-2 Z+2 ID", "rituals_of_the_wilds:small_glass_jar");
			object.addProperty("Replacment Block X+2 Z-2 ID", "rituals_of_the_wilds:small_glass_jar");
			object.addProperty("Replacment Block X-2 Z-2 ID", "rituals_of_the_wilds:small_glass_jar");
			...
			object.addProperty("Result command", "ritualrunetry");
			object.addProperty("Info about result", "You can use any color of ink in any of the five rune placed during this ritual. However, the central rune will produce a unique effect with level one based on the color of central rune.");
			{
