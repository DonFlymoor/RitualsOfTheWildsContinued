...
public class GenerateAlchemyRecipe5Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.ALCHEMYCAULDRONRECIPESREGEN.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Alchemy_Cauldron/eng"), File.separator + "9alchemyrecipe.json");
			try {
			...
			object.addProperty("Name for Alchemy Scroll", "Alchemy Recipe: Diamond -> Emerald Transmutation");
			...
			object.addProperty("Block X-3 ID Or Tag", "rituals_of_the_wilds:wooden_rune_s_standing");
			object.addProperty("Block X+3 ID Or Tag", "rituals_of_the_wilds:wooden_rune_v_standing");
			object.addProperty("Block Z-3 ID Or Tag", "rituals_of_the_wilds:wooden_rune_b_standing");
			object.addProperty("Block Z+3 ID Or Tag", "rituals_of_the_wilds:wooden_rune_u_standing");
			object.addProperty("Block X+2 Z+2 ID Or Tag", "rituals_of_the_wilds:wooden_rune_l_standing");
			object.addProperty("Block X+2 Z-2 ID Or Tag", "rituals_of_the_wilds:wooden_rune_x_standing");
			object.addProperty("Block X-2 Z+2 ID Or Tag", "rituals_of_the_wilds:wooden_rune_o_standing");
			object.addProperty("Block X-2 Z-2 ID Or Tag", "rituals_of_the_wilds:wooden_rune_d_standing");
			...
			object.addProperty("Replacement Block X+2 Y+2 Z-2 ID", "");
			object.addProperty("Replacement Block X-2 Y+2 Z-2 ID", "");
			object.addProperty("Ingredient ID or Tag 1", "minecraft:diamond");
			object.addProperty("Ingredient ID or Tag 2", "");
			object.addProperty("Ingredient ID or Tag 3", "");
			...
			object.addProperty("Result item ID", "minecraft:emerald");
