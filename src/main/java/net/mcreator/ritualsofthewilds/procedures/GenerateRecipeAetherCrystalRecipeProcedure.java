...
public class GenerateRecipeAetherCrystalRecipeProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.RITUALRECIPESREGENERATE.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Rituals/eng"), File.separator + "18ritual.json");
			try {
			...
			object.addProperty("Ritual Name", "Recipe Type Ritual: Aether blob");
			object.addProperty("May Spawn In Ritual Scroll", true);
			object.addProperty("Must Read Scroll First", true);
			object.addProperty("Central Block ID or Tag", "rituals_of_the_wilds:mushroom_feoh");
			object.addProperty("Offhand Item ID or Tag", "rituals_of_the_wilds:tied_dried_mistcap_mushroom");
			...
			object.addProperty("Block X+2 ID or Tag", "rituals_of_the_wilds:mushroom_feoh");
			object.addProperty("Block X-2 ID or Tag", "rituals_of_the_wilds:mushroom_feoh");
			object.addProperty("Block Z+2 ID or Tag", "rituals_of_the_wilds:ash_jear");
			object.addProperty("Block Z-2 ID or Tag", "rituals_of_the_wilds:ash_jear");
			...
			object.addProperty("Result item ID", "rituals_of_the_wilds:aether_blob");
			{
