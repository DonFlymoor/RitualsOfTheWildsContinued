...
public class GenerateQuestsProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENQUESTS.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/quests/eng"), File.separator + "chernobog_first_give.json");
			try {
			...
			object.addProperty("Quest name", "The Heart of the Void");
			object.addProperty("Text Line", "Chernobog craves the essence of the void. Find the rare VoidOpal, forged in darkness, and bring it to me.");
			...
			object.addProperty("Quest Item ID or Tag", "rituals_of_the_wilds:void_opal");
			...
			object.addProperty("Next Quest ID", "chernobog_second_give");
