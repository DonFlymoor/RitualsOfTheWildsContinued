...
public class GenerateAlchemyRecipe8Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.ALCHEMYCAULDRONRECIPESREGEN.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Alchemy_Cauldron/eng"), File.separator + "12alchemyrecipe.json");
			try {
			...
			object.addProperty("Name for Alchemy Scroll", "Alchemy Recipe: Redstone Ore Pure Crushing");
			...
			object.addProperty("Block X-3 ID Or Tag", "rituals_of_the_wilds:stone_rune_base_standing");
			object.addProperty("Block X+3 ID Or Tag", "rituals_of_the_wilds:stone_rune_base_standing");
			object.addProperty("Block Z-3 ID Or Tag", "rituals_of_the_wilds:stone_rune_base_standing");
			object.addProperty("Block Z+3 ID Or Tag", "rituals_of_the_wilds:stone_rune_base_standing");
			...
			object.addProperty("Replacement Block X+2 Y+2 Z-2 ID", "");
			object.addProperty("Replacement Block X-2 Y+2 Z-2 ID", "");
			object.addProperty("Ingredient ID or Tag 1", "forge:redstone_ore");
			...
			object.addProperty("Result item ID", "minecraft:redstone");
			object.addProperty("Min/Fixed result item give count", 12);
			object.addProperty("Max result item give count", 48);
			{
