...
public class GenerateRecipeRitualSecondLevelProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.RITUALRECIPESREGENERATE.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/Rituals/eng"), File.separator + "3ritual.json");
			try {
			...
			object.addProperty("Ritual Name", "Recipe Type Ritual: Eldritch Ink Bottle");
			object.addProperty("May Spawn In Ritual Scroll", true);
			object.addProperty("Must Read Scroll First", true);
			object.addProperty("Central Block ID or Tag", "rituals_of_the_wilds:lunar_sap_yr");
			...
			object.addProperty("Block X+3 ID or Tag", "rituals_of_the_wilds:candle_glass_jar");
			object.addProperty("Block X-3 ID or Tag", "rituals_of_the_wilds:candle_glass_jar");
			object.addProperty("Block Z+3 ID or Tag", "rituals_of_the_wilds:candle_glass_jar");
			object.addProperty("Block Z-3 ID or Tag", "rituals_of_the_wilds:candle_glass_jar");
			object.addProperty("Block X+2 Z+2 ID or Tag", "rituals_of_the_wilds:wooden_rune_k_standing");
			...
			object.addProperty("Replacment Block X+3 ID", "rituals_of_the_wilds:candle_glass_jar");
			object.addProperty("Replacment Block X-3 ID", "rituals_of_the_wilds:candle_glass_jar");
			object.addProperty("Replacment Block Z+3 ID", "rituals_of_the_wilds:candle_glass_jar");
			object.addProperty("Replacment Block Z-3 ID", "rituals_of_the_wilds:candle_glass_jar");
			...
			object.addProperty("Result item ID", "rituals_of_the_wilds:eldritch_ink_bottle");
			{
