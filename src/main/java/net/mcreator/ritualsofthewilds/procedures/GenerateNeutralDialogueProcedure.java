...
public class GenerateNeutralDialogueProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_2.json");
			try {
			...
			object.addProperty("Text Line", "You've returned \u2014 marked not by fear, but by intent. Curious. Most who come here do not come twice.");
			object.addProperty("First Answer Text Line", "\u300B I was sent by the Elder \u2014 a message for your ears only.");
			object.addProperty("First Answer Quest Requirement", "chernobog_elder_delivery");
			object.addProperty("First Answer Quest Requirement State", 3);
			object.addProperty("First Answer Result Dialogue Number", 21);
			...
			object.addProperty("Second Answer Text Line", "\u300B Your knowledge interests me. I offer mine in return.");
			object.addProperty("Second Answer Quest Requirement", "");
			object.addProperty("Second Answer Quest Requirement State", 1);
			object.addProperty("Second Answer Result Dialogue Number", 22);
			...
			object.addProperty("Third Answer Text Line", "\u300B Have I earned a task worthy of your attention?");
			object.addProperty("Third Answer Quest Requirement", "");
			object.addProperty("Third Answer Quest Requirement State", 1);
			object.addProperty("Third Answer Result Dialogue Number", 23);
