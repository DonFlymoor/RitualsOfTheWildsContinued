...
public class GenerateQuest5Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENQUESTS.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/quests/eng"), File.separator + "chernobog_moonlight_ink_bottle_give.json");
			try {
			...
			object.addProperty("Quest name", "Moonlight Offering");
			object.addProperty("Text Line", "Bring Chernobog a Moonlight Ink Bottle. Its pale glow feeds his darker rites\u2014rituals only whispered beneath the cold gaze of the moon.");
			...
			object.addProperty("Quest Item ID or Tag", "rituals_of_the_wilds:moonlight_ink_bottle");
