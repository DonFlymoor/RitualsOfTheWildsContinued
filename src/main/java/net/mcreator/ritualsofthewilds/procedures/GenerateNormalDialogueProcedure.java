...
public class GenerateNormalDialogueProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_3.json");
			try {
			...
			object.addProperty("Text Line", "Hm. You've returned. Not as ash, not as fool. That... is unexpected. Perhaps you're more than noise after all.");
			object.addProperty("First Answer Text Line", "\u300B You\u2019ve seen more than anyone else, haven\u2019t you?");
			object.addProperty("First Answer Quest Requirement", "");
			object.addProperty("First Answer Quest Requirement State", 1);
			object.addProperty("First Answer Result Dialogue Number", 31);
			...
			object.addProperty("Second Answer Text Line", "\u300B Is there something you need done?");
			object.addProperty("Second Answer Quest Requirement", "");
			object.addProperty("Second Answer Quest Requirement State", 1);
			object.addProperty("Second Answer Result Dialogue Number", 32);
			...
			object.addProperty("Third Answer Text Line", "\u300B Tell me about Leshy. You knew him, didn\u2019t you?");
			object.addProperty("Third Answer Quest Requirement", "");
			object.addProperty("Third Answer Quest Requirement State", 1);
			object.addProperty("Third Answer Result Dialogue Number", 33);
			...
			object.addProperty("Fourth Answer Text Line", "\u300B I\u2019ll work for your trust. Whatever that takes.");
			object.addProperty("Fourth Answer Quest Requirement", "");
			object.addProperty("Fourth Answer Quest Requirement State", 1);
			object.addProperty("Fourth Answer Result Dialogue Number", 34);
