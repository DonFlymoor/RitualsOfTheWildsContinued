...
public class TakenAllItemFromSlot11Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof Player _player) {
			...
			}.getItemStack(world, BlockPos.containing(x, y, z), 11)).copy();
		...
		}
		{
			...
			}.getAmount(world, BlockPos.containing(x, y, z), 0) - 1), RandomSource.create(), null)) {
				_ist.shrink(1);
		...
		if (world instanceof Level _level) {
			if (!_level.isClientSide()) {
				_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.bamboo_wood.step")), SoundSource.BLOCKS, 1, (float) 0.5);
			} else {
				_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.bamboo_wood.step")), SoundSource.BLOCKS, 1, (float) 0.5, false);
			}
		}
	}
}
