...
public class GenerateGoodDialogue3Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_42.json");
			try {
			...
			object.addProperty("Text Line", "The shrines were not built to praise. They were anchors \u2014 bolted into the flesh of the world. Something stirs beneath them still. Find where the stone bleeds. Bring me what leaks.");
			object.addProperty("First Answer Text Line", "\u300B I\u2019ll bring you the extract.");
			object.addProperty("First Answer Quest Requirement", "chernobog_deliver_void_extract");
			...
			object.addProperty("First Answer Result Quest Give ID", "chernobog_deliver_void_extract");
			object.addProperty("First Answer Result Command Player, World or Entity Executed", 0);
			object.addProperty("First Answer Sound", "");
			object.addProperty("Second Answer Text Line", "\u300B What is it that leaks from them?");
			...
			object.addProperty("Second Answer Result Command", "tellraw @s \"<Chernobog> A memory too old to think. A hunger too young to understand. Bottle it. Give it to me.\"");
			...
			object.addProperty("Third Answer Text Line", "\u300B I\u2019ll come back when I\u2019m ready.");
			...
			object.addProperty("Third Answer Result Command", "tellraw @s \"<Chernobog> Then let the veins whisper to someone else.\"");
