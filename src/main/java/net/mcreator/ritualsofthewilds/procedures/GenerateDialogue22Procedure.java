...
public class GenerateDialogue22Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_21.json");
			try {
			...
			object.addProperty("Text Line", "So the wrinkled whisperer still remembers me... What does he send? Tribute? Or trembling apologies?");
			object.addProperty("First Answer Text Line", "\u300B Only words. He spoke of old pacts and darker debts.");
			...
			object.addProperty("First Answer Result Command", "give @s rituals_of_the_wilds:umbral_crystal");
			object.addProperty("First Answer Result Quest Give ID", "chernobog_elder_delivery");
			object.addProperty("First Answer Result Command Player, World or Entity Executed", 0);
			object.addProperty("First Answer Sound", "");
			object.addProperty("Second Answer Text Line", "\u300B He begs your favor again. Desperation makes him brave.");
			...
			object.addProperty("Second Answer Result Command", "tellraw @s \"<Chernobog> Desperation is not bravery. It is just the sound of drowning louder than before.\"");
