...
public class GenerateHighDialoguesProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (RitualsOfTheWildsConfigConfiguration.AUTOREGENDIALOGUES.get() == true) {
			file = new File((FMLPaths.GAMEDIR.get().toString() + "/config/Rituals_of_the_wilds/dialogues/eng"), File.separator + "rituals_of_the_wilds_chernobog_5.json");
			try {
			...
			object.addProperty("Text Line", "You stood where others ran. You listened when silence roared. You decayed\u2026 and did not die. So now, I will speak plainly. Few ever reach this rot-soaked altar.");
			object.addProperty("First Answer Text Line", "\u300B Tell me the truth of how it began.");
			object.addProperty("First Answer Quest Requirement", "");
			object.addProperty("First Answer Quest Requirement State", 1);
			object.addProperty("First Answer Result Dialogue Number", 51);
			...
			object.addProperty("Second Answer Text Line", "\u300B What am I now, to you?");
			object.addProperty("Second Answer Quest Requirement", "");
			object.addProperty("Second Answer Quest Requirement State", 1);
			object.addProperty("Second Answer Result Dialogue Number", 52);
			...
			object.addProperty("Third Answer Text Line", "\u300B Is this the end, then?");
			object.addProperty("Third Answer Quest Requirement", "");
			object.addProperty("Third Answer Quest Requirement State", 1);
			object.addProperty("Third Answer Result Dialogue Number", 53);
			...
			object.addProperty("Fourth Answer Text Line", "[Leave in silence.]");
