...
public class ModelDomovoy<T extends DomovoiEntity> extends HierarchicalModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("rituals_of_the_wilds", "model_domovoy"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = root.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 18).addBox(-5.0F,
				-9.0F, -6.0F, 10.0F, 9.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 2.0F));
		PartDefinition legs = Body.addOrReplaceChild("legs", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, -6.0F));
		PartDefinition leg_right = legs.addOrReplaceChild("leg_right", CubeListBuilder.create().texOffs(40, 26).addBox(
				-1.0F, -2.0F, -3.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.0F, 0.0F, 0.0F));
		PartDefinition leg_left = legs.addOrReplaceChild("leg_left", CubeListBuilder.create().texOffs(40, 31).addBox(
				-1.0F, -2.0F, -3.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, 0.0F, 0.0F));
		PartDefinition Head = Body.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(36, 37)
						.addBox(-4.0F, -5.0F, -3.0F, 8.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(40, 18)
						.addBox(-1.0F, -3.0F, -9.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -9.0F, 0.0F));
		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(42, 48)
						.addBox(-2.0F, -4.0F, -1.01F, 3.0F, 4.0F, 0.1F, new CubeDeformation(0.0F)).texOffs(36, 48)
						.addBox(-13.0F, -4.0F, -1.01F, 3.0F, 4.0F, 0.05F, new CubeDeformation(0.0F)),
		...
		PartDefinition Hat = Head.addOrReplaceChild("Hat", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -4.3619F, 1.4188F, -0.1309F, 0.0F, 0.0F));
		PartDefinition cube_r2 = Hat.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 37)
						.addBox(-4.5F, -3.01F, -4.0468F, 9.0F, 3.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-8.5F, 0.0F, -9.0F, 17.0F, 0.05F, 18.0F, new CubeDeformation(0.0F)),
